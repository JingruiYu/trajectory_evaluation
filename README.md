...
python2 analyze_trajectories.py \
  --platform <platform> --odometry_error --overall_odometry_error --plot_trajectories --rmse_table --recalculate_errors
```
...
```
python2 analyze_trajectories_Sem.py \
  --platform Sem --odometry_error --overall_odometry_error --plot_trajectories --rmse_table --recalculate_errors
```

```
python2 analyze_trajectories_My.py \
  --platform My --odometry_error --overall_odometry_error --plot_trajectories --rmse_table --recalculate_errors
```
