...
MAX_TRAJ_LENGTHS = {'upLong': 400} # up Long
...
def saveAligned(dataset_trajectories_dict, dataset_names):
    ...
    np.savetxt('/home/yujr/trajectory_evaluation/results/upLong/ICP.txt',ICP,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upLong/ORB.txt',ORB,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upLong/OUR.txt',OUR,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upLong/Tig.txt',Tig,fmt='%.7f')
    print("<<< ... saveAligned.\n")
