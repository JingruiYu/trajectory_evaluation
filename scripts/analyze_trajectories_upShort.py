...
MAX_TRAJ_LENGTHS = {'upShort': 50} # up short
# boxplot distances that will be used for all datasets for overall errors
OVERALL_BOXPLOT_DISTANCES = [7.0, 14.0, 21.0, 28.0, 35.0] # up short
...
def saveAligned(dataset_trajectories_dict, dataset_names):
    ...
    np.savetxt('/home/yujr/trajectory_evaluation/results/upShort/ICP.txt',ICP,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upShort/ORB.txt',ORB,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upShort/OUR.txt',OUR,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/upShort/Tig.txt',Tig,fmt='%.7f')
    print("<<< ... saveAligned.\n")
