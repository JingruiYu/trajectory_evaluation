...
MAX_TRAJ_LENGTHS = {'downShort': 100} 
# boxplot distances that will be used for all datasets for overall errors
OVERALL_BOXPLOT_DISTANCES = [10.0, 20.0, 30.0, 40.0, 50.0] 
...
def saveAligned(dataset_trajectories_dict, dataset_names):
    ...
    np.savetxt('/home/yujr/trajectory_evaluation/results/downShort/ICP.txt',ICP,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/downShort/ORB.txt',ORB,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/downShort/OUR.txt',OUR,fmt='%.7f')
    np.savetxt('/home/yujr/trajectory_evaluation/results/downShort/Tig.txt',Tig,fmt='%.7f')
    print("<<< ... saveAligned.\n")
