...
ALGORITHM_CONFIGS = ['one', 'two', 'three', 'four', 'five', 'six'] #'Encoder', 'Encoder2', 'Mono', 'Mono2']#, 'MonoBird', 'MonoBird2', 'MonoEnc', 'MonoEnc2']
...
MAX_TRAJ_LENGTHS = {'MH_01': 100} # down short
# MAX_TRAJ_LENGTHS = {'MH_01': 300} # down Long
# MAX_TRAJ_LENGTHS = {'MH_01': 400} # up Long
# MAX_TRAJ_LENGTHS = {'MH_01': 60} # up short
# boxplot distances that will be used for all datasets for overall errors
OVERALL_BOXPLOT_DISTANCES = [10.0, 20.0, 30.0, 40.0, 50] # down short
# OVERALL_BOXPLOT_DISTANCES = [30.0, 60.0, 90.0, 120.0, 150.0] # down Long
# OVERALL_BOXPLOT_DISTANCES = [40.0, 80.0, 120.0, 160.0, 200.0] # up Long
# OVERALL_BOXPLOT_DISTANCES = [10.0, 20.0, 30.0, 40.0, 5.0] # up short
