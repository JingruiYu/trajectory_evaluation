...
ALGORITHM_CONFIGS = ['Bird', 'Encoder2', 'Mono', 'MonoBrid', 'MonoEnc2','SemDir'] #'Encoder', 'Encoder2', 'Mono', 'Mono2']#, 'MonoBird', 'MonoBird2', 'MonoEnc', 'MonoEnc2']

# These are the labels that will be displayed for items in ALGORITHM_CONFIGS
PLOT_LABELS = {'Bird': 'Bird',
               'Encoder2': 'Encoder',
               'Mono': 'Mono',
               'MonoBrid': 'MonoBrid',
               'MonoEnc2': 'MonoEnc2',
